...
// ─── PRODUCTS ────────────────────────────────────────────────────────────────
server.tool("billz_get_products", "Get list of products. Use last_updated_date to sync only changed products.", {
...
server.tool("billz_filter_products", "Filter products with advanced criteria", {
...
server.tool("billz_patch_product_custom_field", "Add or edit a custom field value on a product", {
    product_id: z.string().describe("Product UUID"),
    custom_fields: z.array(z.object({ custom_field_id: z.string(), custom_field_value: z.string() })),
}, async ({ product_id, custom_fields }) => {
    const data = await billzFetch("PATCH", `/v2/product/${product_id}/patch-groups`, { body: { custom_fields } });
    return ok(data);
});
server.tool("billz_create_product", "Create a single product", {
    barcode: z.string(),
    sku: z.string(),
    name: z.string(),
...
// ─── CUSTOMERS ───────────────────────────────────────────────────────────────
server.tool("billz_create_customer", "Create a new customer", {
    first_name: z.string(),
...
server.tool("billz_get_customers", "Get list of customers", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
server.tool("billz_update_customer", "Update customer info", {
...
server.tool("billz_get_customer", "Get detailed info for a single customer", { id: z.string().describe("Customer UUID") }, async ({ id }) => {
    const data = await billzFetch("GET", `/v1/customer/${id}`);
    return ok(data);
});
server.tool("billz_set_customer_balance", "Manually set a customer's cashback balance", {
    id: z.string().describe("Customer UUID"),
...
server.tool("billz_create_customer_card", "Create a loyalty card for a customer", { customer_id: z.string() }, async ({ customer_id }) => {
    const data = await billzFetch("POST", "/v1/client-card", { body: { customer_id } });
    return ok(data);
});
server.tool("billz_get_customers_by_chat_id", "Get customers by Telegram chat_id", {
    chat_id: z.string(),
    page: z.number().int().optional(),
    limit: z.number().int().optional(),
}, async (params) => {
...
server.tool("billz_get_loyalty_program", "Get loyalty program settings", {}, async () => {
    const data = await billzFetch("GET", "/v1/loyalty-program");
    return ok(data);
});
server.tool("billz_get_debt_stats", "Get debt statistics for a customer", { customer_id: z.string() }, async ({ customer_id }) => {
    const data = await billzFetch("GET", "/v1/debt-stats", { params: { customer_id } });
    return ok(data);
});
server.tool("billz_get_debts", "Get list of debts for a customer", {
...
// ─── SALES ───────────────────────────────────────────────────────────────────
server.tool("billz_create_sale", "Create a new sale draft. Returns sale id and order_number.", {
    shop_id: z.string(),
    cashbox_id: z.string(),
...
server.tool("billz_add_product_to_sale", "Add a product to an open sale draft", {
    order_id: z.string(),
    product_id: z.string(),
...
server.tool("billz_apply_discount", "Apply manual discount to entire cart or a specific product", {
    order_id: z.string(),
...
server.tool("billz_attach_customer_to_sale", "Attach a customer to an open sale", {
    order_id: z.string(),
    customer_id: z.string(),
...
server.tool("billz_complete_sale", "Finalize a sale with payment info", {
    order_id: z.string(),
...
server.tool("billz_postpone_sale", "Save a sale draft as a postponed order (reserved stock)", {
    order_id: z.string(),
...
server.tool("billz_recalculate_order_bill", "Recalculate order bill (e.g. after adding gift cards)", { order_id: z.string() }, async ({ order_id }) => {
    const data = await billzFetch("POST", `/v1/recalculate-order-bill/${order_id}?Billz-Response-Channel=HTTP`);
    return ok(data);
});
server.tool("billz_get_sales", "Get list of completed sales", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
server.tool("billz_get_sale_details", "Get details of a specific sale", { order_id: z.string() }, async ({ order_id }) => {
    const data = await billzFetch("GET", `/v2/order/${order_id}`);
    return ok(data);
});
server.tool("billz_get_postponed_sales", "Get list of postponed sales", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
server.tool("billz_get_draft_sales", "Get list of draft sales", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
}, async (params) => {
...
// ─── SUPPLIER ORDERS ─────────────────────────────────────────────────────────
server.tool("billz_create_supplier_order", "Create a new supplier order", {
    name: z.string(),
    shop_id: z.string(),
...
server.tool("billz_add_product_to_supplier_order", "Add a product to a supplier order", {
...
server.tool("billz_update_supplier_order", "Update an unsent supplier order", {
    id: z.string(),
...
server.tool("billz_send_supplier_order", "Change supplier order status to 'Sent'", { id: z.string().describe("Supplier order UUID") }, async ({ id }) => {
...
server.tool("billz_get_supplier_orders", "Get list of supplier orders", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
    shop_ids: z.string().optional(),
...
server.tool("billz_get_supplier_order_products", "Get products in a supplier order", {
    order_id: z.string(),
    shop_id: z.string(),
...
// ─── TRANSFERS ───────────────────────────────────────────────────────────────
server.tool("billz_get_transfers", "Get list of inventory transfers", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
server.tool("billz_create_transfer", "Create a new inventory transfer between shops", {
...
server.tool("billz_add_product_to_transfer", "Add a product to a transfer", {
...
server.tool("billz_send_transfer", "Mark a transfer as sent", { transfer_id: z.string() }, async ({ transfer_id }) => {
    const data = await billzFetch("POST", `/v2/transfer/${transfer_id}/send`, {
        headers: { "Billz-Response-Channel": "HTTP" },
    });
    return ok(data);
});
server.tool("billz_cancel_transfer", "Cancel a transfer", { transfer_id: z.string() }, async ({ transfer_id }) => {
    const data = await billzFetch("DELETE", `/v2/transfer/${transfer_id}`, {
        headers: { "Billz-Response-Channel": "HTTP" },
    });
    return ok(data);
});
server.tool("billz_accept_transfer", "Accept/finish a transfer at the destination shop", {
    transfer_id: z.string(),
...
server.tool("billz_update_transfer", "Update transfer name or shop assignments", {
    transfer_id: z.string(),
    name: z.string().optional(),
...
server.tool("billz_get_transfer_products", "Get products in a transfer", {
    transfer_id: z.string(),
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
// ─── IMPORTS ─────────────────────────────────────────────────────────────────
server.tool("billz_import_products", "Import products (create or update) in bulk. Async — response comes via webhook.", {
    shop_id: z.string(),
...
server.tool("billz_get_imports", "Get list of product imports", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
...
// ─── PROMOTIONS ──────────────────────────────────────────────────────────────
server.tool("billz_get_promos", "Get list of promotions", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
    search: z.string().optional(),
}, async (params) => {
...
server.tool("billz_get_promo", "Get details of a specific promotion", { id: z.string() }, async ({ id }) => {
    const data = await billzFetch("GET", `/v1/promo/${id}`, {
        headers: { "platform-id": "7d4a4c38-dd84-4902-b744-0488b80a4c01" },
    });
    return ok(data);
});
server.tool("billz_get_promo_products", "Get products in a promotion", {
...
// ─── REPORTS ─────────────────────────────────────────────────────────────────
server.tool("billz_report_general_table", "General summary report table (sales, products, customers, sellers stats)", {
...
server.tool("billz_report_general_totals", "General summary report totals (sums)", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
...
server.tool("billz_report_transactions_table", "Transactions report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
...
server.tool("billz_report_transactions_totals", "Transactions report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    limit: z.number().int().optional(),
...
server.tool("billz_report_products_table", "Product sales report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_products_totals", "Product sales report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_product_performance_table", "Product performance/movement report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_product_performance_totals", "Product performance report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_imports_table", "Imports report table (how imported stock sells)", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_imports_totals", "Imports report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_sales_by_suppliers_table", "Sales by suppliers report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    supplier_ids: z.string().optional(),
...
server.tool("billz_report_order_returns_table", "Supplier order returns report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
...
server.tool("billz_report_order_returns_totals", "Supplier order returns report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    display_currency: z.string().optional(),
...
server.tool("billz_report_stocktaking_summary", "Stocktaking (inventory count) summary report table", {
...
server.tool("billz_report_stocktaking_summary_totals", "Stocktaking summary totals", {
    stocktaking_guid: z.string(),
    currency: z.string().optional(),
}, async (params) => {
...
server.tool("billz_report_stock", "Stock on hand report (inventory levels at a specific date)", {
...
server.tool("billz_report_write_offs", "Write-offs report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_sellers_table", "Seller performance report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_customers_table", "Customer statistics report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_customers_totals", "Customer statistics report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_customer_purchases_table", "Customer purchases report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_customer_purchases_totals", "Customer purchases report totals", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_profit_loss", "Profit and loss report", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    currency: z.string().optional(),
...
server.tool("billz_report_cashflow_table", "Cash flow / financial transactions report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
...
server.tool("billz_report_transfers_table", "Inventory transfers report table", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
    display_currency: z.string().optional(),
...
// ─── AUXILIARY ───────────────────────────────────────────────────────────────
server.tool("billz_get_company", "Get current company info", {}, async () => {
    const data = await billzFetch("GET", "/v1/company");
    return ok(data);
});
server.tool("billz_get_shops", "Get list of shops", {
    limit: z.number().int().optional(),
...
server.tool("billz_get_users", "Get list of users (cashiers, sellers)", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
}, async (params) => {
...
server.tool("billz_get_suppliers", "Get list of suppliers", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
    search: z.string().optional(),
}, async (params) => {
...
server.tool("billz_get_categories", "Get product categories", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
    search: z.string().optional(),
...
server.tool("billz_get_brands", "Get list of product brands", {
    limit: z.number().int().optional(),
    page: z.number().int().optional(),
    search: z.string().optional(),
}, async (params) => {
...
server.tool("billz_get_product_characteristics", "Get product custom field definitions", { limit: z.number().int().optional() }, async (params) => {
    const data = await billzFetch("GET", "/v2/product-characteristic", { params });
    return ok(data);
});
server.tool("billz_get_measurement_units", "Get list of measurement units", {}, async () => {
    const data = await billzFetch("GET", "/v2/measurement-unit");
    return ok(data);
});
server.tool("billz_get_product_types", "Get list of product types (simple, service, bundle)", {}, async () => {
    const data = await billzFetch("GET", "/v2/product-types");
    return ok(data);
});
server.tool("billz_get_cashboxes", "Get list of cashboxes (POS terminals)", { limit: z.number().int().optional() }, async (params) => {
    const data = await billzFetch("GET", "/v1/cash-box", { params });
    return ok(data);
});
server.tool("billz_get_payment_types", "Get list of payment methods", { limit: z.number().int().optional() }, async (params) => {
    const data = await billzFetch("GET", "/v1/company-payment-type", { params });
    return ok(data);
});
server.tool("billz_get_currencies", "Get list of company currencies", {}, async () => {
    const data = await billzFetch("GET", "/v2/company-currencies");
    return ok(data);
});
server.tool("billz_get_currency_rates", "Get currency exchange rate history", {
    start_date: z.string().optional(),
    end_date: z.string().optional(),
    currency: z.string().optional(),
    limit: z.number().int().optional(),
...
server.tool("billz_get_report_payment_types", "Get payment type list for transaction reports", {
    start_date: z.string(),
    end_date: z.string().optional(),
    shop_ids: z.string().optional(),
}, async (params) => {
